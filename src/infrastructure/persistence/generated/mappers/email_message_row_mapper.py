...
from src.infrastructure.persistence.schemas.emailmessage_columns import EmailMessageColumns

from src.domain.entities.patient_entities import EmailMessage
